...
export const CustomWithdraw = (props: CustomInputProps) => {
    ...
    return (
        <div className={styles.customInputContainer}>
            <div className={styles.customInputLabels}>
                {/* <label className={styles.customInputAmount}>Amount</label> */}
                <label className={styles.customInput}>Fee Total: {balance ?? '-'}</label>
            </div>
